...
<body>
<div class="wrapper">
    <div id="${genTable.genTable.className?uncap_first}Tree" class="ztree"></div>
</div><!-- ./wrapper -->
...
<script language="javascript" type="text/javascript">
    ...
    var zNodes = ${"$"}{${genTable.genTable.className?uncap_first}Tree};
    function setCheck() {
       $.fn.zTree.init($("#${genTable.genTable.className?uncap_first}Tree"), setting, zNodes);
    }
    // 默认选择节点
    ...
    //初始化
    setCheck();
    var tree = $.fn.zTree.getZTreeObj("${genTable.genTable.className?uncap_first}Tree");
    selectCheckNode();
</script>
</body>
</html>
