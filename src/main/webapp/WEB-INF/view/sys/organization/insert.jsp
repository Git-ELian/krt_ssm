        ...
        <form action="#" id="krtForm" class="form-horizontal">
            <table class="table table-bordered table-krt">
                <tr>
                    ...
                    <td class="width-35">
                        <div class="input-group">
                            <input type="text" name="pname" value="${organization.name}" id="pname" class="form-control" readonly="readonly">
                            <span class="input-group-btn">
									<button class="btn btn-primary btn-flat" id="organizationTreeBtn" type="button"><i class="fa fa-search"></i></button>
								</span>
                            <!-- 参数 -->
                            <input type="hidden" name="pid" id="pid" value="${organization.id==null?'0':organization.id}" class="form-control">
                        </div>
                    </td>
                    <td class="active width-15">
                        <label class="pull-right">
                ...
                <tr>
                    ...
                    <td class="width-35">
                        <input type="text" name="primaryMan" id="primaryMan" class="form-control">
                    </td>
                </tr>
                <tr>
                    <td class="active width-15">
                    ...
                    <td class="width-35"><input type="text" name="linkMan" id="linkMan" class="form-control"></td>
                </tr>
                <tr>
                    <td class="active width-15">
                        <label class="pull-right">
                    ...
                    <td class="width-35"><input type="text" name="zipcode" id="zipcode" class="form-control"></td>
                    <td class="active width-15">
                        <label class="pull-right">
                            手机号码
                        </label>
                    </td>
                    <td class="width-35"><input type="text" name="phone" id="phone" class="form-control"></td>
                </tr>
                <tr>
                    <td class="active width-15">
                        <label class="pull-right">
                    ...
                    <td class="width-35"><input type="text" name="email" id="email" class="form-control"></td>
                    <td class="active width-15">
                        <label class="pull-right">
                            区域信息
                        </label>
                    ...
                    <td class="width-35">
                        <div class="input-group">
                            <input type="text" name="regionName" id="regionName" class="form-control" readonly="readonly">
                            <span class="input-group-btn">
                            ...
                            <input type="hidden" name="regionCode" id="regionCode" class="form-control">
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <textarea type="text" name="remark" id="remark" cols="3" class="form-control"></textarea>
                    </td>
                </tr>
            </table>
        </form>
...
<script type="text/javascript">
    ...
    function doSubmit() {//回调函数，在编辑和保存动作时，供openDialog调用提交表单。
        $.ajax({
            type: "POST",
            url: "${basePath}sys/organization/insert",
