        ...
        <form action="#" id="krtForm" class="form-horizontal">
            <table class="table table-bordered table-krt">
                <tr>
                    ...
                    <td class="width-35"><input type="text" name="name" id="name" value="${quartzJob.name}" class="form-control" required></td>
                    <td class="active width-15">
                        <label class="pull-right">
                            <span class="form-required">*</span>组名
                        </label>
                    </td>
                    <td class="width-35"><input type="text" name="group" id="group" value="${quartzJob.group}" class="form-control" required></td>
                </tr>
                <tr>
                    <td class="active width-15">
                        <label class="pull-right">
                    ...
                    <td class="width-35">
                        <div class="input-group">
                            <input type="text" name="expression" id="expression" value="${quartzJob.expression}" class="form-control" required>
                ...
                <tr>
                    ...
                    <td class="width-35">
                        <input type="text" name="method" id="method" class="form-control" value="${quartzJob.method}" required>
...
<script type="text/javascript">
    ...
    function doSubmit() {//回调函数，在编辑和保存动作时，供openDialog调用提交表单。
        $.ajax({
            type: "POST",
            url: "${basePath}sys/quartzJob/update",
